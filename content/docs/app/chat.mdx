...
One of the attachment menu tiles is **Terminal** — a full-featured command-line session that opens directly in the chat without leaving your conversation. This is ideal for quickly running commands, checking system status, or listing directories while maintaining your chat context.
