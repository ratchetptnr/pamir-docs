...
| Step | User Action | 📱 Mobile App | 📟 Device (E-ink) |
| :--- | :--- | :--- | :--- |
...
The following screens represent the core onboarding flow in the mobile app.

### 1. Discovery & Camera Permission
The app requires camera access to scan the device's QR code.

<div className="flex justify-center my-8">
  <img 
    src="/docs/app/onboarding-camera-permission.png" 
    alt="Camera Permission Screen" 
    className="w-full max-w-[320px] rounded-2xl border shadow-xl"
  />
</div>

### 2. QR Scanning
The user scans the unique QR code displayed on the Distiller's screen.

<div className="flex justify-center my-8">
  <img 
    src="/docs/app/onboarding-qr-scan.png" 
    alt="QR Scanning Screen" 
    className="w-full max-w-[320px] rounded-2xl border shadow-xl"
  />
</div>

### 3. Bluetooth Search
Once scanned, the app searches for the device via Bluetooth.

<div className="flex justify-center my-8">
  <img 
    src="/docs/app/onboarding-ble-search.png" 
    alt="Bluetooth Search Screen" 
    className="w-full max-w-[320px] rounded-2xl border shadow-xl"
  />
</div>

### 4. WiFi Selection
A list of available WiFi networks is retrieved from the device.

<div className="flex justify-center my-8">
  <img 
    src="/docs/app/onboarding-wifi-selection.png" 
    alt="WiFi Selection Screen" 
    className="w-full max-w-[320px] rounded-2xl border shadow-xl"
  />
</div>

### 5. Security & Naming
The final step where the user names their device and sets a secure password.

<div className="flex justify-center my-8">
  <img 
    src="/docs/app/onboarding-security-setup.png" 
    alt="Security Setup Screen" 
    className="w-full max-w-[320px] rounded-2xl border shadow-xl"
  />
</div>

### 6. Setup Complete
The final confirmation screen before entering the main app.

<div className="flex justify-center my-8">
  <img 
    src="/docs/app/onboarding-setup-complete.png" 
