...
| :--- | :--- | :--- | :--- |
| **1. Permissions** | Taps "Connect" | **Camera Permission** | **Status Hub**<br/>(QR code visible) |
| **2. Scanning** | Scans QR Code | **QR Scanner Active** | Unchanged |
| **3. Finding** | Waits for BLE | **BLE Search**<br/>Searching for [ID]... | **Provisioning**<br/>"Establishing Link..." |
| **4. Found** | Taps "Continue" | **Device Found**<br/>Connection established | **Provisioning**<br/>"Link Established" |
...
| **9. Security** | Sets Name/Pass | **Secure Device**<br/>"Name your Distiller" | Unchanged (Online) |
| **10. Complete** | Taps "Go to App" | **All Set!** | **Ready**<br/>[Name].devices... |
