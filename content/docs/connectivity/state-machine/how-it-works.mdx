...
**4. Authentication**
- App requests device password (security gate)
- User enters password set during onboarding
- Device validates password
- If wrong → Show error, allow retry (up to 5 attempts)
- If correct → Unlock BLE commands
